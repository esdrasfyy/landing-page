        ...
        {items.length ? (
          <div className="tf-compare-table">
            ...
            <div className="tf-compare-row">
              ...
              {items.map((elm, i) => (
                <div key={i} className="tf-compare-col tf-compare-field tf-compare-rate">
            ...
            <div className="tf-compare-row">
              ...
              {items.map((elm, i) => (
                <div key={i} className="tf-compare-col tf-compare-field tf-compare-viewcart text-center">
                  <a className="btn-view-cart" onClick={() => addProductToCart(elm.id)}>
                    {isAddedToCartProducts(elm.id) ? "ADICIONADO" : "ADICIONAR"}
                  </a>
                </div>
              ))}
            </div>
