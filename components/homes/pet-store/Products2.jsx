...
export default function Products2() {
  const { addToWishlist, isAddedtoWishlist, addToCompareItem, isAddedtoCompareItem, addProductToCart, isAddedToCartProducts } = useContextElement();
                ...
                <div className="inner-wrapper-card">
                  <div className="card-product-wrapper">
                    <Link href={`/product-detail/${product.id}`} className="product-img">
                      <Image className="lazyload img-product" data-src={product.imgSrc} alt="image-product" src={product.imgSrc} width={600} height={800} />
                      <Image className="lazyload img-hover" data-src={product.imgHoverSrc} alt="image-product" src={product.imgHoverSrc} width={600} height={800} />
                    </Link>
                ...
                <div className="card-product-info">
                  <div className="archive-info-top">
                    ...
                    <div className="inner-bottom">
                      <p className="description text-secondary text-caption-1 text-line-clamp-2">{product.description}</p>
                      <div className="list-product-btn">
                        ...
                        <a href="#compare" onClick={() => addToCompareItem(product.id)} data-bs-toggle="offcanvas" aria-controls="compare" className="box-icon compare btn-icon-action">
                  ...
                  <div className="archive-info-bottom">
                    ...
                    <div className="countdown-box">
                      <div className="js-countdown" data-timer={product.countdown} data-labels="Days,Hours,Mins,Secs">
