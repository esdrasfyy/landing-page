...
export default function ProductCard8({ product, gridClass = "" }) {
  ...
  return (
    <div className={`card-product style-3 ${gridClass} ${product.isOnSale ? "on-sale" : ""} ${product.sizes ? "card-product-size" : ""}`}>
      <div className="card-product-wrapper">
        ...
        <div className="list-btn-main">
          <a href="#quickAdd" data-bs-toggle="modal" onClick={() => setQuickAddItem(product.id)} className="btn-main-product">
            Quick Add
          </a>
          {/* <a href="#quickView" data-bs-toggle="modal" onClick={() => setQuickViewItem(product)} className="box-icon quickview tf-btn-loading">
