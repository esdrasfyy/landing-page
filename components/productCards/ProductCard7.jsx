...
export default function ProductCard7({ product, gridClass = "" }) {
  ...
  return (
    <div className={`card-product style-2 ${gridClass} ${product.isOnSale ? "on-sale" : ""} ${product.sizes ? "card-product-size" : ""}`}>
      <div className="card-product-wrapper">
        ...
        <div className="list-product-btn">
          <a onClick={() => addProductToCart(product.id)} className="box-icon quickadd">
