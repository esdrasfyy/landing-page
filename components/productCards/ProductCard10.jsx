...
export default function ProductCard10({ product, gridClass = "" }) {
  ...
  return (
    <div className={`card-product style-5 wow fadeInUp ${gridClass} ${product.isOnSale ? "on-sale" : ""} ${product.sizes ? "card-product-size" : ""}`}>
      <div className="card-product-wrapper">
        ...
        <div className="list-btn-main">
          <div className="list-btn-main">
            <a href="#quickView" data-bs-toggle="modal" onClick={() => setQuickViewItem(product)} className="quick-view btn-main-product">
              Quick View
            </a>
            <a href="#quickAdd" onClick={() => setQuickAddItem(product.id)} data-bs-toggle="modal" className="btn-main-product">
              Quick Add
            </a>
          </div>
        </div>
