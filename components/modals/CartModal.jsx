        ...
        <div className="modal-content">
                ...
                {products41.map((product, index) => (
                  <div className="list-cart-item" key={index}>
                    ...
                    <div className="content">
                      <div className="name">
                        <Link className="link text-line-clamp-1" href="/product-detail">
                          {product.title}
                        </Link>
                      </div>
                      <div className="cart-item-bot">
                        <div className="text-button price">R${product.price.toFixed(2)}</div>
                        <a className="link text-button" onClick={() => addProductToCart(product.id, 1, false)}>
                          {isAddedToCartProducts(product.id) ? "ADICIONADO" : "ADICIONAR"}
                        </a>
                      </div>
                    </div>
                  </div>
          ...
          <div className="d-flex flex-column flex-grow-1 h-100">
            <div className="header">
              <h5 className="title">Carrinho de Compras</h5>
            ...
            <div className="wrap">
              <div className="tf-mini-cart-threshold">
                ...
                <div className="text-caption-1">Parabéns! Você tem frete grátis!</div>
              </div>
              <div className="tf-mini-cart-wrap">
                          ...
                          <div key={i} className="tf-mini-cart-item file-delete">
                            ...
                            <div className="tf-mini-cart-info flex-grow-1">
                              <div className="mb_12 d-flex align-items-center justify-content-between flex-wrap gap-12">
                                ...
                                <div className="text-button tf-btn-remove remove" onClick={() => removeItem(product.id)}>
                                  Remove
                                </div>
                              </div>
                              <div className="d-flex align-items-end justify-content-between flex-wrap gap-12">
                ...
                <div className="tf-mini-cart-bottom">
                  {/* <div className="tf-mini-cart-tool">
                    <div className="tf-mini-cart-tool-btn btn-add-note" onClick={() => setCurrentOpenPopup("add-note")}>
                    ...
                    <div className="tf-mini-cart-tool-btn btn-estimate-shipping" onClick={() => setCurrentOpenPopup("estimate-shipping")}>
                      <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.333 2.5H0.833008V13.3333H13.333V2.5Z" stroke="#181818" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M13.333 6.66675H16.6663L19.1663 9.16675V13.3334H13.333V6.66675Z" stroke="#181818" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M4.58333 17.4999C5.73393 17.4999 6.66667 16.5672 6.66667 15.4166C6.66667 14.266 5.73393 13.3333 4.58333 13.3333C3.43274 13.3333 2.5 14.266 2.5 15.4166C2.5 16.5672 3.43274 17.4999 4.58333 17.4999Z" stroke="#181818" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M15.4163 17.4999C16.5669 17.4999 17.4997 16.5672 17.4997 15.4166C17.4997 14.266 16.5669 13.3333 15.4163 13.3333C14.2657 13.3333 13.333 14.266 13.333 15.4166C13.333 16.5672 14.2657 17.4999 15.4163 17.4999Z" stroke="#181818" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <div className="text-caption-1">Shipping</div>
                    </div>
                    <div className="tf-mini-cart-tool-btn btn-add-coupon" onClick={() => setCurrentOpenPopup("add-coupon")}>
                      <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="tf-mini-cart-bottom-wrap">
                    <div className="tf-cart-totals-discounts">
                      <h5>Subtotal</h5>
                      <h5 className="tf-totals-total-value">R${totalPrice.toFixed(2)}</h5>
                    </div>
                    ...
                    <div className="tf-mini-cart-view-checkout">
                      <Link href={`/shopping-cart`} className="tf-btn w-100 btn-white radius-4 has-border">
                        <span className="text">Ver Carrinho</span>
                      </Link>
                    ...
                    <div className="text-center">
                      <Link className="link text-btn-uppercase" href={`/shop-default-grid`}>
                        Ou continue comprando
                      </Link>
                    </div>
                  </div>
                </div>
                <div className={`tf-mini-cart-tool-openable ${currentOpenPopup == "add-note" ? "open" : ""}`}>
                  <div className="tf-mini-cart-tool-content">
                    ...
                    <form className="form-add-note tf-mini-cart-tool-wrap" onSubmit={(e) => e.preventDefault()}>
                      <fieldset className="d-flex">
                        <textarea name="note" id="Cart-note" placeholder="Add special instructions for your order..." defaultValue={""} />
                      </fieldset>
                      <div className="tf-cart-tool-btns">
                        ...
                        <div className="text-center w-100 text-btn-uppercase tf-mini-cart-tool-close" onClick={() => setCurrentOpenPopup("")}>
                          Cancel
                        </div>
                      </div>
                    </form>
                ...
                <div className={`tf-mini-cart-tool-openable ${currentOpenPopup == "estimate-shipping" ? "open" : ""} `}>
                  <div className="tf-mini-cart-tool-content">
                    ...
                    <form className="form-estimate-shipping tf-mini-cart-tool-wrap" onSubmit={(e) => e.preventDefault()}>
                      <div className="mb_12">
                        <div className="text-caption-1 text-secondary mb_8">Country/region</div>
                      ...
                      <div className="mb_12">
                        <div className="text-caption-1 text-secondary mb_8">State</div>
                        <div className="tf-select">
                      ...
                      <fieldset className="">
                        <div className="text-caption-1 text-secondary mb_8">Postal/Zip Code</div>
                        <input className="" type="text" placeholder={100000} name="text" tabIndex={2} defaultValue="" aria-required="true" required />
                      </fieldset>
                      <div className="tf-cart-tool-btns">
                        <button type="submit" className="btn-style-2 w-100">
                          <span className="text text-btn-uppercase">Calculator</span>
                        </button>
                        <div className="text-center w-100 text-btn-uppercase tf-mini-cart-tool-close" onClick={() => setCurrentOpenPopup("")}>
                          Cancel
                        </div>
                ...
                <div className={`tf-mini-cart-tool-openable ${currentOpenPopup == "add-coupon" ? "open" : ""} `}>
                  <div className="tf-mini-cart-tool-content">
                    <label className="tf-mini-cart-tool-text">
                      <span className="icon">
                        <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <form className="form-add-coupon tf-mini-cart-tool-wrap" onSubmit={(e) => e.preventDefault()}>
                      <fieldset className="">
                        <div className="text-caption-1 text-secondary mb_8">Enter Code</div>
                        <input className="" type="text" placeholder="Discount code" name="text" tabIndex={2} defaultValue="" aria-required="true" required />
                      </fieldset>
                      <div className="tf-cart-tool-btns">
                        <button type="submit" className="btn-style-2 w-100">
                          <span className="text text-btn-uppercase">Save</span>
